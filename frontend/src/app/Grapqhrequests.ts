...
const RESET_MONDE = gql`
  mutation resetmonde($user: String!) {
...
export { GET_WORLD, LANCER_PRODUCTION, ENGAGER_MANAGER, ACHETER_PRODUIT, ACHETER_CASH_UPGRADE, ACHETER_ANGEL_UPGRADE, RESET_MONDE };